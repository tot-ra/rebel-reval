...
# Source package: content/packages/act3_poide_siege/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act3_poide_siege"
const QUEST_ID := &"quest.act3.poide_siege"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.estonia.poide_church_fortress"
]
const CONTENT_DIRS: Array[String] = [
	"res://content/packages/act3_poide_siege/content",
	"res://content/examples/valid",
	"res://content/examples/support",
]
const BRANCHES: Array[Dictionary] = [
	{
		"id": &"broken_gate_high_losses",
		"route": &"combat",
		"transitions": [
			&"brief",
			&"resolve_broken_gate"
		...
		"expect_flags": [
		{"flag": &"flag.act3.poide_siege.briefed", "value": true},
		{"flag": &"flag.act3.poide_siege.losses_high", "value": true},
		{"flag": &"flag.act3.poide_siege.taken", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act3.poide_siege.broken_gate"
		],
	},
	{
		"id": &"honored_record_ordered_assault",
		"route": &"combat",
		"transitions": [
			&"brief",
		...
		"expect_flags": [
		{"flag": &"flag.act3.poide_siege.briefed", "value": true},
		{"flag": &"flag.act3.poide_siege.record_preserved", "value": true},
		{"flag": &"flag.act3.poide_siege.taken", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act3.poide_siege.honored_record"
		],
	},
	{
		"id": &"hidden_signal_islander_withdrawal",
		"route": &"non_combat",
		"transitions": [
			&"brief",
		...
		"expect_flags": [
		{"flag": &"flag.act3.poide_siege.briefed", "value": true},
		{"flag": &"flag.act3.poide_siege.islanders_withdrawn", "value": true},
		{"flag": &"flag.act3.poide_siege.taken", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act3.poide_siege.hidden_signal"
		],
	}
]
