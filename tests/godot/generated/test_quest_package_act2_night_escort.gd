...
# Source package: content/packages/act2_night_escort/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_night_escort"
const QUEST_ID := &"quest.act2.night.escort"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.viru_street_viru_tanav"
]
const CONTENT_DIRS: Array[String] = ["res://content/packages/act2_night_escort/content", "res://content/examples/support", "res://content/examples/valid"]
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.act2.night.escort.briefed", "value": true},
		{"flag": &"flag.act2.night.escort.combat_resolved", "value": true}
	],
		"expect_ledger_events": [&"ledger.act2.night.escort.combat"],
	},
	{
		"id": &"non_combat_route",
		"route": &"non_combat",
		...
		"expect_flags": [
		{"flag": &"flag.act2.night.escort.briefed", "value": true},
		{"flag": &"flag.act2.night.escort.non_combat_resolved", "value": true}
	],
		"expect_ledger_events": [&"ledger.act2.night.escort.non_combat"],
	}
]
