...
# Source package: content/packages/livonian_order_night_checkpoint/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.livonian_order_night_checkpoint"
const QUEST_ID := &"quest.livonian_order_night_checkpoint"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.viru_gate_viru_varav"
]
const CONTENT_DIRS: Array[String] = [
	"res://content/packages/livonian_order_night_checkpoint/content",
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.order.night_checkpoint.briefed", "value": true},
		{"flag": &"flag.order.night_checkpoint.combat_resolved", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.order.night_checkpoint.combat"
		],
	},
	{
		"id": &"non_combat_route",
		...
		"expect_flags": [
		{"flag": &"flag.order.night_checkpoint.briefed", "value": true},
		{"flag": &"flag.order.night_checkpoint.non_combat_resolved", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.order.night_checkpoint.non_combat"
		],
	}
]
