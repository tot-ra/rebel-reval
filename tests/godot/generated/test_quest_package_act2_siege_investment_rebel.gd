...
# Source package: content/packages/act2_siege_investment_rebel/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_siege_investment_rebel"
const QUEST_ID := &"quest.act2.siege.investment.rebel"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.estonia.rebel_signal_hill_harju"
]
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.investment.rebel.briefed", "value": true},
		{"flag": &"flag.act2.siege.investment.rebel.direct_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.investment", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.investment.rebel.direct"
		],
	},
	{
		"id": &"quiet_route",
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.investment.rebel.briefed", "value": true},
		{"flag": &"flag.act2.siege.investment.rebel.quiet_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.investment", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.investment.rebel.quiet"
		],
	}
]
