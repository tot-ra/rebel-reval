...
# Source package: content/packages/livonian_order_grain_tally/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.livonian_order_grain_tally"
const QUEST_ID := &"quest.livonian_order_grain_tally"
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"setup": {},
		"require_flags": {},
		"expect_state": &"shortage_exposed",
		"expect_flags": [
		{"flag": &"flag.order.grain_tally.reviewed", "value": true},
		{"flag": &"flag.order.grain_tally.shortage_exposed", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.order.grain_tally.shortage_exposed"
		],
	},
	{
		"id": &"quartermaster_spared",
		"transitions": [
			&"brief",
			&"spare_quartermaster"
		],
		"setup": {},
		"require_flags": {},
		"expect_state": &"quartermaster_spared",
		"expect_flags": [
		{"flag": &"flag.order.grain_tally.quartermaster_spared", "value": true},
		{"flag": &"flag.order.grain_tally.reviewed", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.order.grain_tally.quartermaster_spared"
		],
	}
]
