...
# Source package: content/packages/black_cloaks_safehouse_debt/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.black_cloaks_safehouse_debt"
const QUEST_ID := &"quest.black_cloaks_safehouse_debt"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.brotherhood_of_blackheads_site"
]
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"setup": {},
		"require_flags": {},
		"expect_state": &"debt_paid",
		"expect_flags": [
		{"flag": &"flag.cloaks.safehouse_debt.paid_openly", "value": true},
		{"flag": &"flag.cloaks.safehouse_debt.terms_ready", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.cloaks.safehouse_debt.paid_openly"
		],
	},
	{
		"id": &"debt_settled_concealed",
		"transitions": [
			&"negotiate_terms",
			&"settle_concealed"
		],
		"setup": {},
		"require_flags": {},
		"expect_state": &"debt_concealed",
		"expect_flags": [
		{"flag": &"flag.cloaks.safehouse_debt.settled_concealed", "value": true},
		{"flag": &"flag.cloaks.safehouse_debt.terms_ready", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.cloaks.safehouse_debt.settled_concealed"
		],
	}
]
