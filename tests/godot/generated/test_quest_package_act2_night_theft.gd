...
# Source package: content/packages/act2_night_theft/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_night_theft"
const QUEST_ID := &"quest.act2.night.theft"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.eastern_granary_row"
]
const CONTENT_DIRS: Array[String] = ["res://content/packages/act2_night_theft/content", "res://content/examples/support", "res://content/examples/valid"]
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.act2.night.theft.briefed", "value": true},
		{"flag": &"flag.act2.night.theft.combat_resolved", "value": true}
	],
		"expect_ledger_events": [&"ledger.act2.night.theft.combat"],
	},
	{
		"id": &"non_combat_route",
		"route": &"non_combat",
		...
		"expect_flags": [
		{"flag": &"flag.act2.night.theft.briefed", "value": true},
		{"flag": &"flag.act2.night.theft.non_combat_resolved", "value": true}
	],
		"expect_ledger_events": [&"ledger.act2.night.theft.non_combat"],
	}
]
