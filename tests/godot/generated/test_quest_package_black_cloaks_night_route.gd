...
# Source package: content/packages/black_cloaks_night_route/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.black_cloaks_night_route"
const QUEST_ID := &"quest.black_cloaks_night_route"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.viru_street_viru_tanav"
]
const CONTENT_DIRS: Array[String] = [
	"res://content/packages/black_cloaks_night_route/content",
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.cloaks.night_route.briefed", "value": true},
		{"flag": &"flag.cloaks.night_route.combat_resolved", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.cloaks.night_route.combat"
		],
	},
	{
		"id": &"non_combat_route",
		...
		"expect_flags": [
		{"flag": &"flag.cloaks.night_route.briefed", "value": true},
		{"flag": &"flag.cloaks.night_route.non_combat_resolved", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.cloaks.night_route.non_combat"
		],
	}
]
