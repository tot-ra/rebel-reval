...
# Source package: content/packages/act2_night_defense/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_night_defense"
const QUEST_ID := &"quest.act2.night.defense"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.viru_barracks"
]
const CONTENT_DIRS: Array[String] = ["res://content/packages/act2_night_defense/content", "res://content/examples/support", "res://content/examples/valid"]
const BRANCHES: Array[Dictionary] = [
	{
		"id": &"combat_route",
		"route": &"combat",
		"transitions": [&"brief", &"resolve_combat"],
		"setup": {},
		"require_flags": {},
		"expect_state": &"combat_complete",
		"expect_flags": [
		{"flag": &"flag.act2.night.defense.briefed", "value": true},
		{"flag": &"flag.act2.night.defense.combat_resolved", "value": true}
	],
		"expect_ledger_events": [&"ledger.act2.night.defense.combat"],
	},
	{
		"id": &"non_combat_route",
		"route": &"non_combat",
		"transitions": [&"brief", &"resolve_non_combat"],
		"setup": {},
		"require_flags": {},
		"expect_state": &"non_combat_complete",
		"expect_flags": [
		{"flag": &"flag.act2.night.defense.briefed", "value": true},
		{"flag": &"flag.act2.night.defense.non_combat_resolved", "value": true}
	],
		"expect_ledger_events": [&"ledger.act2.night.defense.non_combat"],
	}
]
