...
# Source package: content/packages/black_cloaks_iron_mark/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.black_cloaks_iron_mark"
const QUEST_ID := &"quest.black_cloaks_iron_mark"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.karja_street_smithies"
]
const CONTENT_DIRS: Array[String] = [
	"res://content/packages/black_cloaks_iron_mark/content",
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"setup": {},
		"require_flags": {},
		"expect_state": &"forge_exposed",
		"expect_flags": [
		{"flag": &"flag.cloaks.iron_mark.forge_exposed", "value": true},
		{"flag": &"flag.cloaks.iron_mark.inspected", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.cloaks.iron_mark.forge_exposed"
		],
	},
	{
		"id": &"record_redirected",
		"transitions": [
			&"inspect_marks",
			&"redirect_record"
		],
		"setup": {},
		"require_flags": {},
		"expect_state": &"record_redirected",
		"expect_flags": [
		{"flag": &"flag.cloaks.iron_mark.inspected", "value": true},
		{"flag": &"flag.cloaks.iron_mark.record_redirected", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.cloaks.iron_mark.record_redirected"
		],
	}
]
