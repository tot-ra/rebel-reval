...
# Source package: content/packages/act2_siege_assault_rebel/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_siege_assault_rebel"
const QUEST_ID := &"quest.act2.siege.assault.rebel"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.viru_gate_foreland"
]
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.assault.rebel.briefed", "value": true},
		{"flag": &"flag.act2.siege.assault.rebel.direct_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.assault", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.assault.rebel.direct"
		],
	},
	{
		"id": &"quiet_route",
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.assault.rebel.briefed", "value": true},
		{"flag": &"flag.act2.siege.assault.rebel.quiet_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.assault", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.assault.rebel.quiet"
		],
	}
]
