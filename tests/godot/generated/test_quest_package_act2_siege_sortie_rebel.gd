...
# Source package: content/packages/act2_siege_sortie_rebel/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_siege_sortie_rebel"
const QUEST_ID := &"quest.act2.siege.sortie_supply.rebel"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.estonia.harju_village_crossroads"
]
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.sortie_supply.rebel.briefed", "value": true},
		{"flag": &"flag.act2.siege.sortie_supply.rebel.direct_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.sortie_supply", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.sortie_supply.rebel.direct"
		],
	},
	{
		"id": &"quiet_route",
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.sortie_supply.rebel.briefed", "value": true},
		{"flag": &"flag.act2.siege.sortie_supply.rebel.quiet_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.sortie_supply", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.sortie_supply.rebel.quiet"
		],
	}
]
