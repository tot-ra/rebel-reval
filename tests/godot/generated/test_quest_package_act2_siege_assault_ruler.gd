...
# Source package: content/packages/act2_siege_assault_ruler/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_siege_assault_ruler"
const QUEST_ID := &"quest.act2.siege.assault.ruler"
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.assault.ruler.briefed", "value": true},
		{"flag": &"flag.act2.siege.assault.ruler.direct_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.assault", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.assault.ruler.direct"
		],
	},
	{
		"id": &"quiet_route",
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.assault.ruler.briefed", "value": true},
		{"flag": &"flag.act2.siege.assault.ruler.quiet_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.assault", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.assault.ruler.quiet"
		],
	}
]
