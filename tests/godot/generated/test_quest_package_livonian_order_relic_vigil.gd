...
# Source package: content/packages/livonian_order_relic_vigil/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.livonian_order_relic_vigil"
const QUEST_ID := &"quest.livonian_order_relic_vigil"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.st_mary_s_cathedral_toomkirik"
]
const CONTENT_DIRS: Array[String] = [
	"res://content/packages/livonian_order_relic_vigil/content",
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.order.relic_vigil.returned", "value": true},
		{"flag": &"flag.order.relic_vigil.trail_found", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.order.relic_vigil.returned"
		],
	},
	{
		"id": &"relic_hidden",
		...
		"expect_state": &"hidden",
		"expect_flags": [
		{"flag": &"flag.order.relic_vigil.hidden", "value": true},
		{"flag": &"flag.order.relic_vigil.trail_found", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.order.relic_vigil.hidden"
		],
	}
]
