...
# Source package: content/packages/root_and_ember/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.root_and_ember"
const QUEST_ID := &"quest.root_and_ember"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.estonia.jarvi_maarja_sacred_spring"
]
const CONTENT_DIRS: Array[String] = ["res://content/packages/root_and_ember/content", "res://content/examples/support"]
const BRANCHES: Array[Dictionary] = [
	{
		"id": &"ember_song_peace",
		"transitions": [&"complete_investigation", &"commit_ember_forge"],
		"setup": {},
		"require_flags": {},
		"expect_state": &"aftermath_ember",
		"expect_flags": [
		{"flag": &"flag.ellen.belief_honored", "value": true},
		{"flag": &"flag.root_and_ember_ember_rite", "value": true}
	],
	},
	{
		"id": &"root_ward_peace",
		"transitions": [&"complete_investigation", &"commit_root_forge"],
		"setup": {},
		"require_flags": {},
		"expect_state": &"aftermath_root",
		"expect_flags": [
		{"flag": &"flag.ellen.remedy_trusted", "value": true},
		{"flag": &"flag.root_and_ember_root_ward", "value": true}
	],
	},
	{
		"id": &"iron_bracket_practical",
		"transitions": [&"complete_investigation", &"commit_iron_forge"],
		"setup": {},
		"require_flags": {},
		"expect_state": &"aftermath_iron",
		"expect_flags": [
		{"flag": &"flag.ellen.skepticism_respected", "value": true},
		{"flag": &"flag.root_and_ember_iron_bracket", "value": true}
	],
	}
]
