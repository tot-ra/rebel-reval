...
# Source package: content/packages/act2_siege_sortie_ruler/package.json
# Do not edit by hand.
extends "res://tests/godot/test_case.gd"

const PACKAGE_ID := &"package.act2_siege_sortie_ruler"
const QUEST_ID := &"quest.act2.siege.sortie_supply.ruler"
const LANDMARK_BEATS: Array[StringName] = [
	&"beat.landmark.tallinn.toompea_eastern_ramparts"
]
...
const BRANCHES: Array[Dictionary] = [
	{
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.sortie_supply.ruler.briefed", "value": true},
		{"flag": &"flag.act2.siege.sortie_supply.ruler.direct_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.sortie_supply", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.sortie_supply.ruler.direct"
		],
	},
	{
		"id": &"quiet_route",
		...
		"expect_flags": [
		{"flag": &"flag.act2.siege.sortie_supply.ruler.briefed", "value": true},
		{"flag": &"flag.act2.siege.sortie_supply.ruler.quiet_resolved", "value": true},
		{"flag": &"flag.war.siege_phase.sortie_supply", "value": true}
	],
		"expect_ledger_events": [
			&"ledger.act2.siege.sortie_supply.ruler.quiet"
		],
	}
]
