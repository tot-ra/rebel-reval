...
func test_transition_manifest_includes_dev_traversal_scenes() -> void:
	...
	assert_true(DoorNavigator.has_active_scene(&"reval_harbor_north"), "North harbour should be traversable in dev")
	assert_true(DoorNavigator.has_active_scene(&"reval_harbor_east"), "East harbour should be traversable in dev")
...
func test_transition_manifest_resolves_paths_and_spawns() -> void:
	...
	assert_true(DoorNavigator.has_spawn(&"reval_harbor_north", &"from_reval_north"), "North harbour must expose its Pikk Street spawn")
	assert_true(DoorNavigator.has_spawn(&"reval_harbor_north", &"from_harbor_east"), "Trade Harbour must expose its Fishing Harbour spawn")
	assert_true(DoorNavigator.has_spawn(&"reval_harbor_east", &"from_reval_east"), "East harbour must expose its Viru road spawn")
	assert_true(DoorNavigator.has_spawn(&"reval_harbor_east", &"from_harbor_north"), "Fishing Harbour must expose its Trade Harbour spawn")
