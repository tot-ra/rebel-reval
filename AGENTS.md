...
| Combat or input state-machine tests | **Supported** - `tests/godot/test_player_action_state_machine.gd`, `tests/godot/test_combat_vitals.gd`, `tests/godot/test_forge_technique_iron.gd` | **P1-024** (damage, stamina, techniques) |
