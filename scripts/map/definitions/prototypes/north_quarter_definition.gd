...
static func create() -> MapDefinition:
	...
	InteriorMapFactory.init_definition(
		...
		"north_quarter_v2_street_entries",
		Rect2i(30, 28, 2, 2)
	)

	definition.zones = [
		{"terrain": MapTypes.TERRAIN_COBBLESTONE, "rect": Rect2i(28, 8, 4, 28)},
	...
	definition.view_landmarks = [
		{"id": &"vene_entry_arch", "kind": &"gate_arch", "rect": definition.cell_rect_to_world_rect(Rect2i(28, 34, 4, 2)), "wall_color": Color(0.52, 0.50, 0.46), "top_px": 160.0, "passage_axis": &"z", "door_material": &"wood"},
		{"id": &"center_entry_arch", "kind": &"gate_arch", "rect": definition.cell_rect_to_world_rect(Rect2i(0, 28, 2, 4)), "wall_color": Color(0.52, 0.50, 0.46), "top_px": 160.0, "passage_axis": &"x", "door_material": &"wood"},
	]
