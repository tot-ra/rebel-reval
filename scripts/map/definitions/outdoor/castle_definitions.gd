...
static func haapsalu_castle() -> MapDefinition:
	return _castle(
		&"haapsalu",
		&"loc.haapsalu_castle",
		&"coastal_bishop_castle",
		MapTypes.TERRAIN_MEADOW,
		["res://scenes/world/haapsalu_castle.md"]
	)
...
static func paide_castle() -> MapDefinition:
	return _castle(
		...
		&"limestone_tower",
		MapTypes.TERRAIN_MEADOW,
		["res://scenes/world/paide_castle.md"]
	)
...
static func viljandi_castle() -> MapDefinition:
	return _castle(
		...
		["res://scenes/world/viljandi_castle.md"]
	)
...
static func poide_castle() -> MapDefinition:
	return _castle(
		...
		["res://scenes/world/poide_castle.md"]
	)
