...
static func color(terrain: StringName) -> Color:
	match terrain:
		...
		MapTypes.TERRAIN_MEADOW: return Color8(111, 137, 82)
		...
		MapTypes.TERRAIN_FARM_SOIL: return Color8(104, 71, 49)
		MapTypes.TERRAIN_MUD: return Color8(91, 75, 61)
		...
		MapTypes.TERRAIN_CASTLE_PAVING: return Color8(137, 136, 127)
