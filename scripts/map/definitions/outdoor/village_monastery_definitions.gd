		...
		. create(
			{
				...
				"sources":
				[
					"res://scenes/world/padise/padise_monastery.md",
					"res://scenes/world/padise/padise-map.png"
				],
				"zones":
				[
				...
				[
					Factory.structure(
						&"monastery_church", &"stone_church", Rect2i(20, 7, 10, 6), 82.0
					),
					Factory.structure(
						&"cloister_west", &"monastic_range", Rect2i(17, 14, 5, 8), 58.0
					),
					Factory.structure(
						&"cloister_east", &"monastic_range", Rect2i(34, 14, 6, 8), 58.0
					),
