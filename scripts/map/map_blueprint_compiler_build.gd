...
static func _compile_building(values: Dictionary, definition: MapDefinition) -> Dictionary:
	...
	_copy_fields(values, output, [&"wall_height", &"wall_height_scale", &"wall_color", &"roof_color", &"door_side", &"ridge_axis", &"wall_walk_axis", &"interior_side", &"primitive", &"tower", &"round_tower", &"wall_material", &"roof_material", &"faction"])
	return output
...
static func _compile_prop(values: Dictionary, definition: MapDefinition) -> Dictionary:
	...
	_copy_fields(values, output, [&"facing", &"style_variant", &"visual_offset_px", &"primitive", &"movement_speed_multiplier", &"faction", &"display_goods"])
