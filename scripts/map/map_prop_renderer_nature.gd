...
static func draw_bush(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_circle(
		parent, "BushA", Vector2(-8, -6), 11.0, foliage.darkened(0.06), target, time_of_day
	)
	Draw.add_circle(parent, "BushB", Vector2(7, -8), 10.0, foliage, target, time_of_day)
	Draw.add_circle(
		parent, "BushC", Vector2(1, -3), 8.0, foliage.lightened(0.08), target, time_of_day
	)


static func draw_tree(
	...
	Draw.add_rect(
		parent,
		"Trunk",
		Vector2(-3 * scale, -8 * scale),
		Vector2(6 * scale, 18 * scale),
		trunk_color,
		target,
		time_of_day
	)
	match MapViewTreeSpecies.silhouette_for(species):
		...
		MapViewTreeSpecies.SILHOUETTE_COLUMN:
			...
			Draw.add_circle(
				parent,
				"CrownHigh",
				Vector2(2 * scale, -28 * scale),
				9.0 * scale,
				foliage.lightened(0.05),
				target,
				time_of_day
			)
		_:
			Draw.add_circle(
				parent, "Crown", Vector2(0, -22 * scale), 18.0 * scale, foliage, target, time_of_day
			)
			Draw.add_circle(
				parent,
				"CrownSide",
				Vector2(10 * scale, -16 * scale),
				11.0 * scale,
				foliage.darkened(0.05),
				target,
				time_of_day
			)


static func draw_timber_fence(
	parent: Node2D, prop: Dictionary, target: StringName, time_of_day: StringName
) -> void:
	var wood := MapVisualStyle.role_color(&"wood", target, time_of_day)
...
static func draw_cattle(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_polygon(
		parent,
		"Body",
		Draw.ellipse(Vector2(-3, -10), Vector2(26, 16), 16),
		hide,
		target,
		time_of_day
	)
	Draw.add_polygon(
		parent,
		"Head",
		PackedVector2Array([Vector2(17, -19), Vector2(34, -15), Vector2(36, -4), Vector2(18, -3)]),
		hide.darkened(0.06),
		target,
		time_of_day
	)
	Draw.add_line(
		parent,
		"HornNorth",
		PackedVector2Array([Vector2(25, -17), Vector2(34, -25)]),
		target,
		time_of_day,
		&"hay"
	)
	Draw.add_line(
		parent,
		"HornSouth",
		PackedVector2Array([Vector2(27, -5), Vector2(36, 1)]),
		target,
		time_of_day,
		&"hay"
	)
	...
	Draw.add_circle(
		parent, "Muzzle", Vector2(36, -8), 5.0, horn.darkened(0.18), target, time_of_day
	)
...
static func draw_sheep(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	for tuft in [Vector2(-13, -11), Vector2(0, -16), Vector2(13, -10), Vector2(-3, -4)]:
		Draw.add_circle(
			parent,
			"Wool%d" % parent.get_child_count(),
			tuft,
			12.0,
			wool.darkened(absf(tuft.x) * 0.002),
			target,
			time_of_day
		)
	Draw.add_polygon(
		parent,
		"Head",
		PackedVector2Array([Vector2(17, -14), Vector2(31, -11), Vector2(30, 0), Vector2(17, -2)]),
		hide,
		target,
		time_of_day
	)
...
static func draw_horse(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_polygon(
		parent,
		"Body",
		Draw.ellipse(Vector2(-5, -13), Vector2(27, 14), 16),
		coat,
		target,
		time_of_day
	)
	Draw.add_polygon(
		parent,
		"Neck",
		PackedVector2Array([Vector2(13, -21), Vector2(25, -33), Vector2(34, -27), Vector2(22, -8)]),
		coat.darkened(0.04),
		target,
		time_of_day
	)
	Draw.add_polygon(
		...
		"Head",
		PackedVector2Array(
			[Vector2(24, -36), Vector2(43, -35), Vector2(46, -27), Vector2(31, -24)]
		),
		coat,
		target,
		time_of_day
	...
	Draw.add_polygon(
		parent,
		"Ear",
		PackedVector2Array([Vector2(28, -35), Vector2(28, -45), Vector2(34, -36)]),
		dark,
		target,
		time_of_day
	)
	for leg in [-18.0, -4.0, 10.0, 19.0]:
		Draw.add_rect(
			parent, "Leg%d" % int(leg), Vector2(leg, -4), Vector2(4, 19), dark, target, time_of_day
		)
	Draw.add_line(
		parent,
		"Tail",
		PackedVector2Array([Vector2(-30, -18), Vector2(-39, -8), Vector2(-37, 4)]),
		target,
		time_of_day,
		&"ink"
	)
	Draw.add_rect(
		...
		Vector2(-13, -27),
		Vector2(20, 12),
		MapVisualStyle.role_color(&"hay", target, time_of_day).darkened(0.12),
		target,
		time_of_day
	)
