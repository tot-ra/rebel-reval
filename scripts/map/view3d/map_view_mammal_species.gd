...
const PROFILES: Dictionary = {
	...
	SPECIES_CAT: {"name": "Domestic cat", "group": GROUP_FELID, "scale_m": 0.42, "pose": POSE_RESTING, "colors": [Color("8a7a62"), Color("4a4038"), Color("e8ddd0")], "geometry": {"body": Vector3(0.48, 0.22, 0.20), "tail": 0.22}, "abundance": 0.72, "spawn": {CONTEXT_LOWER_TOWN: 0.92, CONTEXT_MARKET: 0.68}},
	...
	SPECIES_RAT: {"name": "Brown rat", "group": GROUP_RODENT, "scale_m": 0.24, "pose": POSE_STANDING, "colors": [Color("6a5a48"), Color("4a4038"), Color("2a2824")], "geometry": {"body": Vector3(0.28, 0.12, 0.10), "tail": 0.26}, "abundance": 0.82, "spawn": {CONTEXT_LOWER_TOWN: 0.86, CONTEXT_HARBOR: 0.72}},
