...
const GROUP_SPAWN_WEIGHTS: Dictionary = {
	GROUP_GULL:
	{
		...
		CONTEXT_MARKET: 0.46,
		CONTEXT_MONASTERY: 0.08,
		CONTEXT_TOOMPEA: 0.10,
		CONTEXT_FORELAND: 0.30,
		CONTEXT_WETLAND: 0.38,
	...
	GROUP_TERN:
	{
		...
		CONTEXT_TOOMPEA: 0.02,
		CONTEXT_FORELAND: 0.40,
		CONTEXT_WETLAND: 0.72,
		CONTEXT_WOODLAND: 0.0,
		CONTEXT_GARDEN: 0.0
	},
	GROUP_WATERFOWL:
	{
		CONTEXT_HARBOR: 0.62,
		CONTEXT_LOWER_TOWN: 0.02,
		CONTEXT_MARKET: 0.03,
		CONTEXT_MONASTERY: 0.06,
		CONTEXT_TOOMPEA: 0.0,
		CONTEXT_FORELAND: 0.38,
		CONTEXT_WETLAND: 1.0,
		CONTEXT_WOODLAND: 0.04,
		CONTEXT_GARDEN: 0.18
	},
	GROUP_WADER:
	{
		...
		CONTEXT_WETLAND: 1.0,
		CONTEXT_WOODLAND: 0.05,
		CONTEXT_GARDEN: 0.08
	},
	GROUP_RAPTOR:
	{
		CONTEXT_HARBOR: 0.32,
		CONTEXT_LOWER_TOWN: 0.10,
		CONTEXT_MARKET: 0.06,
		CONTEXT_MONASTERY: 0.12,
		CONTEXT_TOOMPEA: 0.52,
		CONTEXT_FORELAND: 0.82,
		CONTEXT_WETLAND: 0.54,
	...
	GROUP_OWL:
	{
		...
		CONTEXT_MARKET: 0.05,
		CONTEXT_MONASTERY: 0.36,
		CONTEXT_TOOMPEA: 0.34,
		CONTEXT_FORELAND: 0.46,
		CONTEXT_WETLAND: 0.18,
		CONTEXT_WOODLAND: 1.0,
		CONTEXT_GARDEN: 0.30
	},
	GROUP_CORVID:
	{
		CONTEXT_HARBOR: 0.52,
		CONTEXT_LOWER_TOWN: 0.86,
		CONTEXT_MARKET: 1.0,
		CONTEXT_MONASTERY: 0.70,
		CONTEXT_TOOMPEA: 0.68,
		CONTEXT_FORELAND: 0.64,
		CONTEXT_WETLAND: 0.38,
		CONTEXT_WOODLAND: 0.60,
		CONTEXT_GARDEN: 0.62
	},
	GROUP_SWALLOW:
	{
		CONTEXT_HARBOR: 0.58,
		CONTEXT_LOWER_TOWN: 0.82,
		CONTEXT_MARKET: 0.72,
		CONTEXT_MONASTERY: 0.66,
		CONTEXT_TOOMPEA: 0.45,
		CONTEXT_FORELAND: 0.88,
		CONTEXT_WETLAND: 0.66,
	...
	{
		CONTEXT_HARBOR: 0.16,
		CONTEXT_LOWER_TOWN: 0.54,
		CONTEXT_MARKET: 0.42,
		CONTEXT_MONASTERY: 0.72,
		CONTEXT_TOOMPEA: 0.46,
		CONTEXT_FORELAND: 0.78,
		CONTEXT_WETLAND: 0.44,
		CONTEXT_WOODLAND: 0.80,
		CONTEXT_GARDEN: 1.0
	},
	GROUP_WOODPECKER:
	{
