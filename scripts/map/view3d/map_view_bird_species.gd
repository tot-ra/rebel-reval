...
## flight, and voice playback are owned by P0-105; this catalog has no gameplay interaction.
...
const PROFILES: Dictionary = {
	...
	SPECIES_MALLARD: {"name": "Mallard", "group": GROUP_WATERFOWL, "scale_m": 0.56, "pose": POSE_STANDING, "colors": [Color("766a4d"), Color("335b4d"), Color("d3a442")], "breast": Color("77503a"), "geometry": {"neck": 0.13, "beak": 0.26}, "song": {"cue": &"bird.mallard.call", "kind": &"quack", "time": &"day", "cadence_s": Vector2(4.0, 13.0)}, "abundance": 0.82},
	...
	SPECIES_NORTHERN_LAPWING: {"name": "Northern lapwing", "group": GROUP_WADER, "scale_m": 0.30, "pose": POSE_STANDING, "colors": [Color("303d39"), Color("dedbd0"), Color("6f8a69")], "crest": true, "geometry": {"neck": 0.08, "legs": 0.27, "beak": 0.16, "body": Vector3(0.45, 0.22, 0.23)}, "song": {"cue": &"bird.northern_lapwing.call", "kind": &"peewit", "time": &"day", "cadence_s": Vector2(3.0, 10.0)}, "abundance": 0.70, "spawn": {CONTEXT_FORELAND: 0.90}},
	...
	SPECIES_HOUSE_SPARROW: {"name": "House sparrow", "group": GROUP_SONGBIRD, "scale_m": 0.15, "pose": POSE_PERCHED, "colors": [Color("8a7255"), Color("4b453d"), Color("c5ad7e")], "breast": Color("c9bda6"), "geometry": {"body": Vector3(0.32, 0.21, 0.20), "beak": 0.09}, "song": {"cue": &"bird.house_sparrow.call", "kind": &"cheep_chatter", "time": &"day", "cadence_s": Vector2(1.5, 5.0)}, "abundance": 1.0, "spawn": {CONTEXT_LOWER_TOWN: 1.0, CONTEXT_MARKET: 0.95}},
	...
	SPECIES_YELLOWHAMMER: {"name": "Yellowhammer", "group": GROUP_SONGBIRD, "scale_m": 0.17, "pose": POSE_PERCHED, "colors": [Color("c3b44d"), Color("76694a"), Color("e0cf59")], "breast": Color("d9c34a"), "song": {"cue": &"bird.yellowhammer.song", "kind": &"descending_phrase", "time": &"day", "cadence_s": Vector2(3.0, 9.0)}, "abundance": 0.66, "spawn": {CONTEXT_FORELAND: 0.94, CONTEXT_GARDEN: 0.62}},
	SPECIES_COMMON_CHAFFINCH: {"name": "Common chaffinch", "group": GROUP_SONGBIRD, "scale_m": 0.15, "pose": POSE_PERCHED, "colors": [Color("b77f66"), Color("526678"), Color("e1d6bc")], "breast": Color("c08a70"), "song": {"cue": &"bird.common_chaffinch.song", "kind": &"descending_trill", "time": &"dawn_day", "cadence_s": Vector2(2.5, 8.0)}, "abundance": 0.90},
	SPECIES_GREAT_TIT: {"name": "Great tit", "group": GROUP_SONGBIRD, "scale_m": 0.14, "pose": POSE_PERCHED, "colors": [Color("b9b44b"), Color("2d3536"), Color("e1d9c3")], "breast": Color("cfc45a"), "geometry": {"body": Vector3(0.30, 0.22, 0.20), "tail": 0.21}, "song": {"cue": &"bird.great_tit.song", "kind": &"two_note_repeat", "time": &"dawn_day", "cadence_s": Vector2(2.0, 7.0)}, "abundance": 0.92},
	SPECIES_EUROPEAN_ROBIN: {"name": "European robin", "group": GROUP_SONGBIRD, "scale_m": 0.14, "pose": POSE_PERCHED, "colors": [Color("786b55"), Color("9f5134"), Color("c8b58c")], "breast": Color("b3603c"), "geometry": {"body": Vector3(0.29, 0.23, 0.21), "tail": 0.18}, "song": {"cue": &"bird.european_robin.song", "kind": &"thin_fluting_warble", "time": &"dawn_dusk", "cadence_s": Vector2(4.0, 11.0)}, "abundance": 0.78},
...
static func breast_color_for(species: StringName) -> Color:
	...
	return colors[0].lightened(0.14) if not colors.is_empty() else Color.LIGHT_GRAY
