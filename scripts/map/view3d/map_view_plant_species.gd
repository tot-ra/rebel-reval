...
const PROFILES: Dictionary = {
	SPECIES_NETTLE:
	{
		"archetype": ARCHETYPE_HERB,
		"height": 0.72,
		"spread": 0.24,
		"stems": 5,
		"density": 0.34,
		"color": Color(0.30, 0.66, 0.24),
		"accent": Color(0.62, 0.82, 0.44)
	},
	SPECIES_MUGWORT:
	{
		"archetype": ARCHETYPE_HERB,
		...
		"stems": 6,
		"density": 0.30,
		"color": Color(0.48, 0.66, 0.42),
		"accent": Color(0.70, 0.76, 0.58)
	},
	SPECIES_YARROW:
	{
		"archetype": ARCHETYPE_FLOWER,
		"height": 0.62,
		"spread": 0.26,
		"stems": 5,
		"density": 0.30,
		"color": Color(0.38, 0.68, 0.30),
		"accent": Color(0.94, 0.91, 0.72)
	},
	SPECIES_PLANTAIN:
	{
		"archetype": ARCHETYPE_ROSETTE,
		"height": 0.28,
		"spread": 0.34,
		"stems": 7,
		"density": 0.35,
		"color": Color(0.36, 0.62, 0.28),
		"accent": Color(0.38, 0.30, 0.18)
	},
	SPECIES_DANDELION:
	{
		"archetype": ARCHETYPE_FLOWER,
		...
		"stems": 4,
		"density": 0.34,
		"color": Color(0.40, 0.70, 0.28),
		"accent": Color(1.00, 0.78, 0.08)
	},
	SPECIES_BURDOCK:
	{
		"archetype": ARCHETYPE_BROAD,
		"height": 0.72,
		"spread": 0.54,
		"stems": 6,
		"density": 0.25,
		"color": Color(0.30, 0.58, 0.26),
		"accent": Color(0.58, 0.30, 0.55)
	},
	SPECIES_THISTLE:
	{
		"archetype": ARCHETYPE_FLOWER,
		...
		"stems": 4,
		"density": 0.24,
		"color": Color(0.36, 0.58, 0.30),
		"accent": Color(0.68, 0.36, 0.72)
	},
	SPECIES_CLOVER:
	{
		"archetype": ARCHETYPE_ROSETTE,
		...
		"stems": 9,
		"density": 0.48,
		"color": Color(0.42, 0.76, 0.32),
		"accent": Color(0.90, 0.82, 0.88)
	},
	SPECIES_FERN:
	{
		"archetype": ARCHETYPE_FROND,
		"height": 0.48,
		"spread": 0.52,
		"stems": 7,
		"density": 0.38,
		"color": Color(0.24, 0.58, 0.24),
		"accent": Color(0.44, 0.70, 0.34)
	},
	SPECIES_MOSS:
	{
		"archetype": ARCHETYPE_MOSS,
		"height": 0.10,
		"spread": 0.42,
		"stems": 9,
		"density": 0.54,
		"color": Color(0.32, 0.56, 0.28),
		"accent": Color(0.50, 0.64, 0.32)
	},
	SPECIES_REED:
	{
		"archetype": ARCHETYPE_REED,
		"height": 1.12,
		"spread": 0.24,
		"stems": 7,
		"density": 0.42,
		"color": Color(0.56, 0.72, 0.34),
		"accent": Color(0.74, 0.66, 0.34)
	},
	SPECIES_CATTAIL:
	{
		"archetype": ARCHETYPE_CATTAIL,
		"height": 1.02,
		"spread": 0.30,
		"stems": 5,
		"density": 0.38,
		"color": Color(0.42, 0.68, 0.32),
		"accent": Color(0.30, 0.16, 0.08)
	},
	SPECIES_WATER_LILY:
	{
		"archetype": ARCHETYPE_AQUATIC,
		"height": 0.12,
		"spread": 0.56,
		"stems": 5,
		"density": 0.32,
		"color": Color(0.28, 0.58, 0.30),
		"accent": Color(0.96, 0.90, 0.82)
	},
	SPECIES_CABBAGE:
	{
		"archetype": ARCHETYPE_BROAD,
		...
		"stems": 10,
		"density": 0.40,
		"color": Color(0.48, 0.68, 0.38),
		"accent": Color(0.68, 0.78, 0.54)
	},
	SPECIES_TURNIP:
	{
		"archetype": ARCHETYPE_ROSETTE,
		...
		"stems": 8,
		"density": 0.40,
		"color": Color(0.42, 0.70, 0.32),
		"accent": Color(0.76, 0.64, 0.78)
	},
	SPECIES_ONION:
	{
		"archetype": ARCHETYPE_STALK,
		"height": 0.54,
		"spread": 0.18,
		"stems": 7,
		"density": 0.46,
		"color": Color(0.38, 0.66, 0.34),
		"accent": Color(0.84, 0.82, 0.72)
	},
	SPECIES_GARLIC:
	{
		"archetype": ARCHETYPE_STALK,
		...
		"stems": 6,
		"density": 0.44,
		"color": Color(0.46, 0.70, 0.38),
		"accent": Color(0.84, 0.76, 0.86)
	},
	SPECIES_PEA:
	{
		"archetype": ARCHETYPE_VINE,
		"height": 0.78,
		"spread": 0.34,
		"stems": 6,
		"density": 0.38,
		"color": Color(0.38, 0.70, 0.30),
		"accent": Color(0.82, 0.82, 0.92)
	},
	SPECIES_BROAD_BEAN:
	{
		"archetype": ARCHETYPE_HERB,
		...
		"stems": 5,
		"density": 0.36,
		"color": Color(0.34, 0.66, 0.30),
		"accent": Color(0.82, 0.76, 0.88)
	},
	SPECIES_RYE:
	{
		"archetype": ARCHETYPE_CEREAL,
		"height": 1.12,
		"spread": 0.24,
		"stems": 8,
		"density": 0.50,
		"color": Color(0.64, 0.70, 0.34),
		"accent": Color(0.72, 0.62, 0.28)
	},
	SPECIES_WHEAT:
	{
		"archetype": ARCHETYPE_CEREAL,
		...
		"stems": 9,
		"density": 0.52,
		"color": Color(0.76, 0.70, 0.34),
		"accent": Color(0.86, 0.68, 0.26)
	},
	SPECIES_BARLEY:
	{
		"archetype": ARCHETYPE_CEREAL,
		...
		"stems": 8,
		"density": 0.50,
		"color": Color(0.70, 0.72, 0.36),
		"accent": Color(0.82, 0.72, 0.30)
	},
	SPECIES_OAT:
	{
		"archetype": ARCHETYPE_CEREAL,
		...
		"stems": 7,
		"density": 0.46,
		"color": Color(0.58, 0.70, 0.36),
		"accent": Color(0.78, 0.72, 0.44)
	},
	SPECIES_FLAX:
	{
		"archetype": ARCHETYPE_FLOWER,
		...
		"stems": 7,
		"density": 0.46,
		"color": Color(0.34, 0.64, 0.32),
		"accent": Color(0.42, 0.60, 0.92)
	},
	SPECIES_HEMP:
	{
		"archetype": ARCHETYPE_STALK,
		...
		"stems": 6,
		"density": 0.38,
		"color": Color(0.28, 0.60, 0.28),
		"accent": Color(0.48, 0.68, 0.36)
	},
	SPECIES_HOPS:
	{
		"archetype": ARCHETYPE_VINE,
		...
		"stems": 7,
		"density": 0.34,
		"color": Color(0.32, 0.64, 0.28),
		"accent": Color(0.66, 0.72, 0.34)
	},
	SPECIES_MINT:
	{
		"archetype": ARCHETYPE_HERB,
		...
		"stems": 7,
		"density": 0.42,
		"color": Color(0.34, 0.72, 0.42),
		"accent": Color(0.68, 0.52, 0.78)
	},
	SPECIES_CARAWAY:
	{
		"archetype": ARCHETYPE_FLOWER,
	...
	SPECIES_ST_JOHNS_WORT:
	{
		...
		"stems": 6,
		"density": 0.34,
		"color": Color(0.38, 0.66, 0.30),
		"accent": Color(0.96, 0.76, 0.16)
	},
}
