...
const PROP_OVERRIDE_KEYS: Array[StringName] = [
	...
	&"movement_speed_multiplier", &"faction", &"display_goods", &"table_items",
]
...
const ALL_STYLE_KEYS: Array[StringName] = [
	...
	&"movement_speed_multiplier", &"tower", &"round_tower", &"wall_material", &"roof_material", &"house_tier", &"faction", &"display_goods", &"table_items",
