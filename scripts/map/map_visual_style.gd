...
## Rendering-only profiles. Pixel and woodcut preserve P0-036 evidence; the clean-painted ID remains
## a compatibility alias for the saturated style-lock-v1.1 production palette. None of these values
## may alter gameplay geometry.
...
static func terrain_color(
	terrain_id: StringName, target: StringName, time_of_day: StringName
) -> Color:
...
static func apply_time(
	...
	if target != TARGET_CLEAN_PAINTED:
		...
		var legacy_night := Color(
			day_color.r * 0.43, day_color.g * 0.50, day_color.b * 0.66, day_color.a
		)
...
static func rules_signature(target: StringName, time_of_day: StringName) -> String:
	return (
		"%s:%s:height=%d:pivot=%s:outline=%.1f:shadow=%s@%.2f"
		% [
			String(target),
			String(time_of_day),
			CHARACTER_HEIGHT_PX,
...
static func _pixel_terrain(terrain_id: StringName) -> Color:
	match terrain_id:
		MapTypes.TERRAIN_GRASS:
			return Color8(86, 111, 64)
		MapTypes.TERRAIN_SAND:
			return Color8(185, 151, 91)
		MapTypes.TERRAIN_HAY:
			return Color8(196, 153, 55)
		MapTypes.TERRAIN_DIRT:
			return Color8(112, 78, 57)
		MapTypes.TERRAIN_COBBLESTONE:
			return Color8(92, 88, 82)
		MapTypes.TERRAIN_WATER:
			return Color8(52, 103, 124)
		MapTypes.TERRAIN_RIVER_WATER:
			return Color8(66, 122, 152)
		MapTypes.TERRAIN_STONE:
			return Color8(132, 130, 120)
		MapTypes.TERRAIN_ASH:
			return Color8(96, 92, 88)
		MapTypes.TERRAIN_TIMBER_FLOOR:
			return Color8(118, 82, 52)
		MapTypes.TERRAIN_PLASTER:
			return Color8(188, 168, 132)
		_:
...
static func _woodcut_terrain(terrain_id: StringName) -> Color:
	match terrain_id:
		MapTypes.TERRAIN_GRASS:
			return Color8(112, 119, 75)
		MapTypes.TERRAIN_SAND:
			return Color8(190, 164, 113)
		MapTypes.TERRAIN_HAY:
			return Color8(174, 140, 62)
		MapTypes.TERRAIN_DIRT:
			return Color8(125, 91, 67)
		MapTypes.TERRAIN_COBBLESTONE:
			return Color8(102, 96, 86)
		MapTypes.TERRAIN_WATER:
			return Color8(66, 99, 105)
		MapTypes.TERRAIN_RIVER_WATER:
			return Color8(74, 118, 138)
		MapTypes.TERRAIN_STONE:
			return Color8(145, 136, 116)
		MapTypes.TERRAIN_ASH:
			return Color8(104, 98, 92)
		MapTypes.TERRAIN_TIMBER_FLOOR:
			return Color8(122, 86, 56)
		MapTypes.TERRAIN_PLASTER:
			return Color8(198, 178, 140)
		_:
			return Color.MAGENTA
...
static func _clean_terrain(terrain_id: StringName) -> Color:
	match terrain_id:
		...
		MapTypes.TERRAIN_ASH:
			return Color8(107, 108, 126)
		MapTypes.TERRAIN_TIMBER_FLOOR:
			return Color8(107, 63, 53)
		MapTypes.TERRAIN_PLASTER:
			return Color8(231, 201, 142)
		_:
			return Color.MAGENTA
...
static func _pixel_role(role: StringName) -> Color:
	match role:
		&"ink":
			return Color8(32, 25, 23)
		&"soot":
			return Color8(48, 42, 36)
		&"plaster":
			return Color8(180, 157, 119)
		&"timber":
			return Color8(72, 47, 36)
		&"roof":
			return Color8(91, 51, 43)
		&"stone":
			return Color8(126, 125, 118)
		&"metal":
			return Color8(65, 72, 75)
		&"wood":
			return Color8(103, 66, 40)
		&"hay":
			return Color8(197, 153, 55)
		&"window":
			return Color8(99, 151, 166)
		&"water_highlight":
			return Color8(89, 163, 179)
		&"character_cloth":
			return Color8(166, 58, 47)
		&"character_skin":
			return Color8(205, 157, 111)
		&"character_apron":
			return Color8(79, 91, 91)
		&"ember":
			return Color8(214, 98, 42)
		&"flower":
			return Color8(196, 108, 132)
		&"vegetation":
			return Color8(72, 104, 58)
		_:
			return Color.MAGENTA
...
static func _woodcut_role(role: StringName) -> Color:
	match role:
		&"ink":
			return Color8(38, 29, 24)
		&"soot":
			return Color8(52, 44, 36)
		&"plaster":
			return Color8(205, 184, 142)
		&"timber":
			return Color8(62, 45, 34)
		&"roof":
			return Color8(83, 53, 40)
		&"stone":
			return Color8(145, 136, 116)
		&"metal":
			return Color8(52, 55, 52)
		&"wood":
			return Color8(91, 62, 39)
		&"hay":
			return Color8(178, 142, 62)
		&"window":
			return Color8(97, 125, 122)
		&"water_highlight":
			return Color8(103, 142, 143)
		&"character_cloth":
			return Color8(151, 49, 42)
		&"character_skin":
			return Color8(195, 156, 111)
		&"character_apron":
			return Color8(69, 75, 68)
		&"ember":
			return Color8(196, 88, 38)
		&"flower":
			return Color8(176, 96, 118)
		&"vegetation":
			return Color8(68, 96, 54)
		_:
			return Color.MAGENTA
...
static func _clean_role(role: StringName) -> Color:
	match role:
		&"ink":
			return Color8(23, 27, 42)
		&"soot":
			return Color8(48, 39, 55)
		&"plaster":
			return Color8(231, 201, 142)
		&"timber":
			return Color8(107, 63, 53)
		&"roof":
			return Color8(185, 74, 61)
		&"stone":
			return Color8(158, 173, 185)
		&"metal":
			return Color8(57, 76, 101)
		&"wood":
			return Color8(162, 105, 63)
		&"hay":
			return Color8(227, 184, 63)
		&"window":
			return Color8(88, 199, 232)
		&"water_highlight":
			return Color8(70, 199, 216)
		&"character_cloth":
			return Color8(217, 54, 77)
		&"character_skin":
			return Color8(224, 160, 117)
		&"character_apron":
			return Color8(64, 82, 123)
		&"ember":
			return Color8(240, 161, 62)
		&"flower":
			return Color8(201, 74, 155)
		&"vegetation":
			return Color8(79, 149, 79)
		_:
			return Color.MAGENTA
