...
const PROP_KIND_CELLAR_NECK := &"cellar_neck"
const PROP_KIND_PLOT_WALL := &"plot_wall"
const PROP_KIND_WATTLE_FENCE := &"wattle_fence"
const PROP_KIND_YARD_GATE := &"yard_gate"
const PROP_KIND_PRIVY := &"privy"
const PROP_KIND_WELL_SWEEP := &"well_sweep"
const PROP_KIND_SERVANT_LEAN_TO := &"servant_lean_to"
const PROP_KIND_HOIST_BEAM := &"hoist_beam"
const PROP_KIND_LOADING_HATCH := &"loading_hatch"
...
const DISTRICT_LIFE_PROP_KINDS: Array[StringName] = [
	...
	PROP_KIND_CELLAR_NECK,
	PROP_KIND_PLOT_WALL,
	PROP_KIND_WATTLE_FENCE,
	PROP_KIND_YARD_GATE,
	PROP_KIND_PRIVY,
	PROP_KIND_WELL_SWEEP,
	PROP_KIND_SERVANT_LEAN_TO,
	PROP_KIND_HOIST_BEAM,
	PROP_KIND_LOADING_HATCH,
	PROP_KIND_ROPE_COIL,
