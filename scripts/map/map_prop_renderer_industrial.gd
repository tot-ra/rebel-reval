...
static func draw_anvil(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_rect(
		parent, "Stump", Vector2(-14, -2), Vector2(28, 14), wood.darkened(0.08), target, time_of_day
	)
	...
	Draw.add_rect(
		...
		Vector2(-12, -26),
		Vector2(26, 5),
		metal.lightened(0.16),
		target,
		time_of_day
	)


static func draw_hay_stack(
	...
	var size_variant := StringName(
		prop.get("style_variant", MapPropStyleVariants.DEFAULT_HAY_STACK_VARIANT)
	)
...
static func draw_cart(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_circle(
		parent, "WheelL", Vector2(-20, 4), 9.0, wood.darkened(0.28), target, time_of_day
	)
	Draw.add_circle(parent, "WheelR", Vector2(20, 4), 9.0, wood.darkened(0.28), target, time_of_day)
	Draw.add_rect(
		parent, "Shaft", Vector2(26, -6), Vector2(25, 4), wood.darkened(0.12), target, time_of_day
	)
...
static func draw_well(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_rect(
		parent, "Curb", Vector2(-24, -4), Vector2(48, 8), stone.darkened(0.10), target, time_of_day
	)
	Draw.add_line(
		parent,
		"WaterGlint",
		PackedVector2Array([Vector2(-8, -12), Vector2(8, -12)]),
		target,
		time_of_day,
		&"water_highlight"
	)
...
static func draw_furnace(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_rect(
		parent, "LeftCheek", Vector2(-34, -16), Vector2(12, 30), stone, target, time_of_day
	)
	Draw.add_rect(
		parent, "RightCheek", Vector2(22, -16), Vector2(12, 30), stone, target, time_of_day
	)
	Draw.add_rect(
		parent,
		"Firebox",
	...
	Draw.add_rect(
		parent, "FireMouth", Vector2(-12, -14), Vector2(24, 16), ember, target, time_of_day
	)
...
static func draw_bellows(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_rect(
		parent, "Stand", Vector2(-16, 2), Vector2(28, 8), wood.darkened(0.12), target, time_of_day
	)
	Draw.add_rect(
		parent, "BoardBottom", Vector2(-18, -4), Vector2(34, 6), wood, target, time_of_day
	)
	Draw.add_rect(
		parent, "Leather", Vector2(-14, -16), Vector2(26, 12), leather, target, time_of_day
	)
	Draw.add_rect(
		parent,
		"BoardTop",
	...
	Draw.add_rect(
		parent, "Lever", Vector2(-20, -34), Vector2(5, 14), wood.darkened(0.08), target, time_of_day
	)


static func draw_blacksmith_tongs(
	parent: Node2D, target: StringName, time_of_day: StringName
) -> void:
	var metal := MapVisualStyle.role_color(&"metal", target, time_of_day)
	Draw.add_line(
		parent,
		"LeftHandle",
		PackedVector2Array([Vector2(-8, 8), Vector2(-3, -7), Vector2(0, -16)]),
		target,
		time_of_day,
		&"metal"
	)
	...
	Draw.add_circle(
		parent, "Rivet", Vector2(0, -7), 3.0, metal.lightened(0.08), target, time_of_day
	)
	Draw.add_rect(
		parent,
		"LeftJaw",
...
static func draw_blacksmith_hammer(
	parent: Node2D, target: StringName, time_of_day: StringName
) -> void:
	var metal := MapVisualStyle.role_color(&"metal", target, time_of_day)
	Draw.add_line(
		parent,
		"Haft",
		PackedVector2Array([Vector2(-6, 10), Vector2(1, -17)]),
		target,
		time_of_day,
		&"wood"
	)
	...
	Draw.add_rect(
		...
		Vector2(-14, -23),
		Vector2(5, 10),
		metal.lightened(0.14),
		target,
		time_of_day
	)


static func draw_blacksmith_punch(
	parent: Node2D, target: StringName, time_of_day: StringName
) -> void:
	var metal := MapVisualStyle.role_color(&"metal", target, time_of_day)
	Draw.add_polygon(
		...
		"Punch",
		PackedVector2Array(
			[Vector2(-4, 8), Vector2(4, 8), Vector2(3, -16), Vector2(0, -24), Vector2(-3, -16)]
		),
		metal,
		target,
		time_of_day
...
static func draw_ledger(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	var wood := MapVisualStyle.role_color(&"wood", target, time_of_day)
	Draw.add_rect(
		parent, "LedgerDesk", Vector2(-20, -10), Vector2(40, 14), wood, target, time_of_day
	)
	Draw.add_rect(
		parent,
		"LedgerBook",
...
static func draw_table(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_rect(
		parent, "LegL", Vector2(-30, 4), Vector2(7, 14), wood.darkened(0.12), target, time_of_day
	)
	Draw.add_rect(
		parent, "LegR", Vector2(23, 4), Vector2(7, 14), wood.darkened(0.12), target, time_of_day
	)
...
static func draw_stairs(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	for step in 4:
		...
		Draw.add_rect(
			parent,
			"Step%d" % step,
			Vector2(-20 + step * 3, -8 + y),
			Vector2(40 - step * 6, 5),
			stone.darkened(step * 0.04),
			target,
			time_of_day
		)
...
static func draw_stall(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	var plaster := MapVisualStyle.role_color(&"plaster", target, time_of_day)
	Draw.add_rect(
		parent, "StallCounter", Vector2(-22, -10), Vector2(44, 12), wood, target, time_of_day
	)
	Draw.add_polygon(
		parent,
		"Awning",
		PackedVector2Array(
			[Vector2(-26, -18), Vector2(26, -18), Vector2(18, -28), Vector2(-18, -28)]
		),
		plaster.darkened(0.05),
		target,
		time_of_day
	)
...
static func draw_hearth(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	var ember := MapVisualStyle.role_color(&"ember", target, time_of_day)
	Draw.add_rect(
		parent, "HearthBase", Vector2(-20, -10), Vector2(40, 16), stone, target, time_of_day
	)
	Draw.add_rect(
		parent, "HearthFire", Vector2(-10, -6), Vector2(20, 8), ember, target, time_of_day
	)


static func draw_kitchenware(
	parent: Node2D, prop: Dictionary, target: StringName, time_of_day: StringName
) -> void:
	var wood := MapVisualStyle.role_color(&"wood", target, time_of_day)
	...
	if variant.begins_with(&"kitchenware.group."):
		Draw.add_rect(
			parent, "GroupBase", Vector2(-18, -10), Vector2(36, 14), wood, target, time_of_day
		)
		Draw.add_rect(
			parent, "GroupAccent", Vector2(-10, -14), Vector2(20, 6), pottery, target, time_of_day
		)
		return
	match variant:
		MapTypes.KITCHENWARE_KNIFE, MapTypes.KITCHENWARE_SPOON:
			Draw.add_rect(
				parent, "Utensil", Vector2(-10, -2), Vector2(20, 4), wood, target, time_of_day
			)
		MapTypes.KITCHENWARE_JUG, MapTypes.KITCHENWARE_COOKING_POT_LIDDED:
			Draw.add_rect(
				parent, "Vessel", Vector2(-6, -12), Vector2(12, 16), pottery, target, time_of_day
			)
		MapTypes.KITCHENWARE_BASIN_CLOTH:
			Draw.add_circle(parent, "Basin", Vector2(0, -4), 10.0, wood, target, time_of_day)
		_:
			Draw.add_rect(
				parent, "Kitchenware", Vector2(-10, -6), Vector2(20, 10), wood, target, time_of_day
			)


static func draw_household_clutter(
	parent: Node2D, prop: Dictionary, target: StringName, time_of_day: StringName
) -> void:
	var wood := MapVisualStyle.role_color(&"wood", target, time_of_day)
	var bread := MapVisualStyle.role_color(&"plaster", target, time_of_day).darkened(0.18)
	var pottery := MapVisualStyle.role_color(&"plaster", target, time_of_day).darkened(0.12)
	var variant := StringName(prop.get("style_variant", MapTypes.DEFAULT_HOUSEHOLD_CLUTTER_VARIANT))
	if variant.begins_with(&"household.group."):
		Draw.add_rect(
			parent, "GroupBase", Vector2(-18, -10), Vector2(36, 14), wood, target, time_of_day
		)
		Draw.add_rect(
			parent, "GroupAccent", Vector2(-10, -14), Vector2(20, 6), bread, target, time_of_day
		)
		return
	match variant:
		MapTypes.PROVISION_BEER_JUG, MapTypes.PROVISION_SALT_CROCK:
			Draw.add_rect(
				parent, "Vessel", Vector2(-6, -12), Vector2(12, 16), pottery, target, time_of_day
			)
		MapTypes.HOUSEHOLD_WATER_BUCKET:
			Draw.add_circle(parent, "Bucket", Vector2(0, -6), 10.0, wood, target, time_of_day)
		MapTypes.HOUSEHOLD_BROOM:
			Draw.add_rect(
				parent, "Broom", Vector2(-2, -10), Vector2(4, 20), wood, target, time_of_day
			)
		MapTypes.HOUSEHOLD_APRON, MapTypes.HOUSEHOLD_LINEN_FOLDED:
			Draw.add_rect(
				parent,
				"Cloth",
				Vector2(-10, -6),
				Vector2(20, 10),
				bread.lightened(0.08),
				target,
				time_of_day
			)
		_:
			Draw.add_rect(
				parent, "Provision", Vector2(-10, -6), Vector2(20, 10), bread, target, time_of_day
			)
...
static func draw_chair(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_rect(
		parent, "Back", Vector2(-9, -18), Vector2(18, 14), wood.darkened(0.08), target, time_of_day
	)
	Draw.add_rect(
		parent, "LegL", Vector2(-8, 4), Vector2(4, 10), wood.darkened(0.14), target, time_of_day
	)
	Draw.add_rect(
		parent, "LegR", Vector2(4, 4), Vector2(4, 10), wood.darkened(0.14), target, time_of_day
	)
...
static func draw_candle(parent: Node2D, target: StringName, time_of_day: StringName) -> void:
	...
	Draw.add_rect(
		parent, "Wax", Vector2(-2, -6), Vector2(4, 10), plaster.lightened(0.12), target, time_of_day
	)
