...
const NorthQuarter := preload(
	"res://scripts/map/definitions/prototypes/north_quarter_rrmap_factory.gd"
)
...
const MarketCivicQuarter := preload(
	"res://scripts/map/definitions/prototypes/market_civic_quarter_rrmap_factory.gd"
)
...
const ViruGateForeland := preload(
	"res://scripts/map/definitions/outdoor/viru_gate_foreland_rrmap_factory.gd"
)
const RevalHarborNorth := preload(
	"res://scripts/map/definitions/outdoor/reval_harbor_north_rrmap_factory.gd"
)
const RevalHarborEast := preload(
	"res://scripts/map/definitions/outdoor/reval_harbor_east_rrmap_factory.gd"
)
...
static func entries() -> Array[Dictionary]:
	return [
		...
		},
		{
			...
			"source": "res://content/maps/rentenitorn_interior.rrmap",
			"factory": RentenitornInterior,
			"required_anchors":
			[
		...
		},
		{
			...
			"required_anchors":
			[&"inspection_spawn", &"archbishops_garden", &"medieval_well", &"western_view"],
		},
		{
			"id": &"toompea_quarter",
		...
		},
		{
			...
			"required_anchors":
			[&"inspection_spawn", &"altar_front", &"nave_center", &"south_entry"],
		},
		{
