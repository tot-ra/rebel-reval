class_name BreadAndIronAftermath
extends Node

## Patrol bark differences after the civic weighing-house bracket install (P4-004).

const MODEL := preload("res://scripts/investigation/bread_and_iron_aftermath_model.gd")
...
func _spawn_patrol_bark(
	...
	_patrol_bark.name = "BreadAndIronPatrolBark"
