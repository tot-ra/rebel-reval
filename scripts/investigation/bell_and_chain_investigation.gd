class_name BellAndChainInvestigation
extends Node

## Daytime Viru Gate evidence loop for quest.bell_and_chain (P4-002).
...
const SITES: Array[Dictionary] = [
	{
		"interactable_id": &"interact.bell_and_chain.portcullis",
		"position_kind": &"prop",
		"position_id": &"gate_cart",
		"dialogue_id": &"dialogue.bell_and_chain.inspect_portcullis",
		"fact_id": &"fact.bell_and_chain.portcullis_wear",
		"prompt": "Inspect the portcullis groove",
	},
	{
		"interactable_id": &"interact.bell_and_chain.patrol_log",
		"position_kind": &"anchor",
		"position_id": &"checkpoint_east",
		"dialogue_id": &"dialogue.bell_and_chain.inspect_patrol",
		"fact_id": &"fact.bell_and_chain.patrol_rotation",
		"prompt": "Read the patrol rotation log",
	},
	{
		"interactable_id": &"interact.bell_and_chain.striker",
		"position_kind": &"prop",
		"position_id": &"viru_wall_walk_stairs",
		"dialogue_id": &"dialogue.bell_and_chain.inspect_striker",
		"fact_id": &"fact.bell_and_chain.striker_stress",
		"prompt": "Inspect the bell striker winch",
	},
	{
		"interactable_id": &"interact.bell_and_chain.rebel_marks",
		"position_kind": &"prop",
		"position_id": &"viru_wall_walk_entry",
		"dialogue_id": &"dialogue.bell_and_chain.inspect_rebel_marks",
		"fact_id": &"fact.bell_and_chain.rebel_gate_map",
		"prompt": "Study the rebel chalk marks",
	},
]
...
func _build_dialogue_stack() -> void:
	...
	_dialogue_ui.name = "BellAndChainDialogueUI"
	_scene_root.add_child(_dialogue_ui)

	_runner = RunnerScript.new()
	_runner.name = "BellAndChainDialogueRunner"
	add_child(_runner)
...
func _build_view_binder(view_runtime: MapViewRuntime, definition: MapDefinition) -> void:
	...
	_view_binder.name = "BellAndChainInteractableViewBinder"
