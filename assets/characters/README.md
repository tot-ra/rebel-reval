...
**Live Kalev** keeps stable paths in [`kalev/kalev.tscn`](kalev/kalev.tscn) and [`kalev/kalev_variant.tres`](kalev/kalev_variant.tres) while the rebuilt body, forge wardrobe, and art pipeline live in [`kalev_fresh/`](kalev_fresh/). See [`kalev/README.md`](kalev/README.md).
