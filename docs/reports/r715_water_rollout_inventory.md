...
- [`map_view_materials.gd`](../../scripts/map/view3d/map_view_materials.gd) remains the public facade for water APIs; the closed `WATER_WAVE_BASE` catalog lives in [`map_view_water_materials.gd`](../../scripts/map/view3d/map_view_water_materials.gd) and is re-exported on the facade. No map source or stable terrain ID is changed.
