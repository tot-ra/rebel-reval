...
- Markdown files excluded as archive/reference/out of active scope: `390`
- Local/external links inspected: `450`
- Links to active Markdown docs: `182`
- Links to existing archive/reference/non-active local docs: `91`
