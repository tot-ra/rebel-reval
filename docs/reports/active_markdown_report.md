...
- Markdown files excluded as archive/reference/out of active scope: `469`
- Local/external links inspected: `545`
- Links to active Markdown docs: `251`
- Links to existing archive/reference/non-active local docs: `110`
