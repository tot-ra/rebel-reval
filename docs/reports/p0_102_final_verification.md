...
| Asset lint | **BLOCKED - external character owner** | `python3 tools/verify_asset_lint.py` reports `assets/characters/shared/sergeant.glb`: tier-1 named-NPC triangle budget `57168 > 56000`. No environment-kit asset is implicated. |
