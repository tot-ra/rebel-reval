...
Companion to [`WITCHER3_REALISM_INSPIRATION.md`](WITCHER3_REALISM_INSPIRATION.md), which covers gameplay realism, and [ADR 0022](adr/0022-realistic-human-characters.md), which governs appearance (realistic, KCD2 / Witcher 3 reference; supersedes ADR 0018's fantasy/anime finish). Sections below written for the ADR 0018 look describe history, not the target. Historical foundation rows P0-140 through P0-160 described the first fidelity pipeline; open character presentation follow-ups after the 2026-08-12 review live in [`CHARACTER_REALISM_BACKLOG.md`](CHARACTER_REALISM_BACKLOG.md) (**P0-188**..**P0-198**) and are indexed from [`../TODO.md`](../TODO.md).
