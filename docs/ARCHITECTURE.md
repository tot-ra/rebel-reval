...
| `scripts/map/view3d/map_view_runtime_camera.gd` (508) | **Keep** camera modes, zoom, and follow beside the runtime facade; ground/building/visibility safety and occlusion ghost live in `map_view_runtime_camera_safety.gd`. Gate: `test_map_view_3d_runtime`, `test_map_view_runtime_camera`, `test_map_camera_modes`, and camera/click filters. |
