...
| `scripts/map/view3d/map_view_runtime_camera.gd` (291) | **Keep** camera modes, zoom, and follow beside the runtime facade; orbit in `map_view_runtime_camera_orbit.gd`, safety in `map_view_runtime_camera_safety.gd`, third-person target resolution in `map_view_runtime_camera_target.gd`, zoom in `map_view_runtime_camera_zoom.gd`, and perspective exposure/DOF in `map_view_runtime_camera_perspective.gd`. Gate: `test_map_view_3d_runtime`, `test_map_view_runtime_camera`, `test_map_camera_modes`, and camera/click filters. |
