...
- P0-185 (partial): `map_view_runtime_camera_orbit.gd` now owns keyboard/mouse yaw and pitch orbit; `map_view_runtime_camera.gd` dropped from 330 to 291 lines and remains the public mode/follow owner. Gate: `test_map_view_runtime_camera`, `test_map_camera_modes`, `test_map_view_3d_runtime`.
