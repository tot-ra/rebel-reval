...
| `scripts/map/view3d/map_view_runtime_camera.gd` (405) | **Keep** camera modes, zoom, orbit, and follow beside the runtime facade; safety in `map_view_runtime_camera_safety.gd`, third-person target resolution in `map_view_runtime_camera_target.gd`, and perspective exposure/DOF in `map_view_runtime_camera_perspective.gd`. Gate: `test_map_view_3d_runtime`, `test_map_view_runtime_camera`, `test_map_camera_modes`, and camera/click filters. |
