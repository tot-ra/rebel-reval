...
| `scenes/reval_south/reval_south.tscn` | level | `convert` | `loc.lower_town.south_quarter` | `active=false` prototype; historically south of the civic square and Karja Gate approach | `scripts/map/definitions/prototypes/south_quarter_definition.gd` |
| `scenes/reval_toompea/reval_toompea.tscn` | level | `convert` | `loc.toompea.quarter` | `active=false` prototype; Upper Town linked by Lühike Jalg from the civic west edge | `scripts/map/definitions/prototypes/toompea_quarter_definition.gd` |
