...
- Rebuild outputs (with `production/production_build.py`): `production/runtime/forge_cat_production_v1.glb`, coats under `production/runtime/tex/`, LODs under `production/lod/`.
