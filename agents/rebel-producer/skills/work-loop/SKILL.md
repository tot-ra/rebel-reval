...
- The `## R - Historical research backlog` section belongs to the Researcher loop. Never create, re-order, or delete `R-###` rows; reconcile their claim, blocked, and canon tags like any other row.
