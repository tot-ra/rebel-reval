...
New lessons must be appended to the shared playbook or the narrowest relevant role playbook. Do not rebuild identical copies across every agent. Append a durable reusable rule, not a dated incident log or a second copy of an existing lesson.
