...
## Superseded epilogue (non-canon)

The plague-as-divine-justice ending **The Last Song** (1351) and its child-transmission reveal are **not canon** and are not planned content. The full text is archived at [`archive/plague_justice_epilogue.md`](./archive/plague_justice_epilogue.md).

For the active campaign ending model, see [`README.md`](../README.md) - Campaign outline and [`docs/CANON.md`](../docs/CANON.md) - Superseded narrative.
