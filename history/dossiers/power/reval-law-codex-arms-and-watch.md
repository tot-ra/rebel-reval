---
domain: power
slug: reval-law-codex-arms-and-watch
status: solid
consumers: [quest, dev, narrative, character]
related:
...
## Brief for Quest / Dev / Narrative

You are enforcing **written Lübeck law inside Lower Town**, not inventing a modern police code. April–May 1343 Reval's working statute is the **1282 Revaler Kodex** (168 Low German articles, Latin prologue), preceded by the **1257 Latin codex** and rooted in Eric IV's **1248** grant of *ius Lubicense* [1][2][3]. Defence is a **burgher obligation tied to citizenship**, not a paid garrison contract.
...
### Legal corpus — what sat on the Vogt's bench in 1343

| Text | Date | Reval status | Confidence |
|---|---|---|---|
| Eric IV privilege granting Lübeck law | **1248** | Foundation; wounding judged by councillors and king's men | attested [1] |
| First written Lübeck-law codex (Latin) | **1257** | Received; seal use from this period | attested [2][23] |
| **Revaler Kodex** (MLG, **168 articles**) | **1282** | Primary statute book in 1343; TLA Cm 6 | attested [2][3] |
| Working copy / Schreibbuch | **1282+** | Cm 10 tradition — everyday court reference | attested [3] |
| **Burspraken** (oral proclamations) | ongoing | Schoß, Wacht, arms upkeep, night rest | plausible composite [5][6] |
| Council craft *Schragen* | **1363+** | **Absent** for forge and other Ämter in 1343 | attested gap [21] |

Kala's editorial note: daughter towns knew Lübeck's privileges but **could not follow every Lübeck-specific paragraph verbatim**; Danish royal charters and local practice also shaped Reval [11]. Do not treat the 1282 book as a complete modern code — it is a **received Hanseatic snapshot**, not a 1343 enforcement log.
...
### Burspraken layer — watch, arms, night order

Hanse Lexikon summarises the **Bürgereid / Burspraken** obligations recurring in Lübeck-law towns [5]:

| Duty | Content | 1343 Reval | Confidence |
|---|---|---|---|
| **Schoß** | Tax / contribution | Siege levy (**11 May 1343** grain to crown attested separately) | attested event; Schoß label composite [27] |
| **Wacht** | Watch service on walls and gates | April siege muster | plausible composite [5][17] |
| **Harnisch und Waffen** | Keep armour and weapons fit | Arms-check before gate duty | plausible composite [5][13] |
| **Nachtruhe** | Observe night rest | Curfew after evening bell | plausible composite [5][17] |
| **Feuer und Licht** | Fire and light discipline | Fire-watch overlap on watch nights | plausible composite [5][17] |

### Arms and muster — how codex + custom combine

| Question | Answer | Confidence |
|---|---|---|
| Who sets kit standard? | **Council** through Burspraken and muster inspection; not the smith *Amt* alone | plausible composite [5][12] |
...
|-------|-------|----------------------|---------|---------|
| [`power.reval-law-codex-arms-and-watch.01`](../../reference/power/reval-law-codex-arms-and-watch/power.reval-law-codex-arms-and-watch.01.jpg) | 1282 Reval Lübeck-law codex manuscript | TLA Cm 6 / Tallinn City Museum photo, 1282 ms | public domain | prop for Stadtschreiber's statute book |
| [`power.reval-law-codex-arms-and-watch.02`](../../reference/power/reval-law-codex-arms-and-watch/power.reval-law-codex-arms-and-watch.02.jpg) | MLG legal text page layout | Oldenburger Sachsenspiegel f. 7r, 1336 ms | public domain | chancery script on proclamation scrolls |
| [`power.reval-law-codex-arms-and-watch.03`](../../reference/power/reval-law-codex-arms-and-watch/power.reval-law-codex-arms-and-watch.03.jpg) | pole arms, swords, shields | Codex Wallerstein f. 1r, c. 1420, Augsburg | public domain | arms-check silhouettes at muster |
| [`power.reval-law-codex-arms-and-watch.04`](../../reference/power/reval-law-codex-arms-and-watch/power.reval-law-codex-arms-and-watch.04.jpg) | limestone wall-walk and parapet | Tallinn Stadtmauer photo, 2014 | CC BY-SA 4.0 | where *Wacht* duty physically happens |
| [`power.reval-law-codex-arms-and-watch.05`](../../reference/power/reval-law-codex-arms-and-watch/power.reval-law-codex-arms-and-watch.05.jpg) | seated secular judges | Dresdner Sachsenspiegel fol. 4, c. 1350 | public domain | Vogt/Rat fining gate breach |
...
1. DD 1248.05.15, https://tekstnet.dk/books/dipdan/1248/dd_12480515001/ — Eric IV grants Lübeck law; wounding judgement (Danish regesta).
2. Geschichtsquellen.de, Werk/5024, https://geschichtsquellen.de/werk/5024 — 1257 Latin and 1282 MLG Reval codices (German).
3. T. Kala (ed.), *Der Revaler Kodex des lübischen Rechts 1282*, Tallinn 1998 — 168 articles, transcription, parallel numbering (German/Estonian).
4. T. Kala, "Das Geschriebene und das Mündliche," in Cordes (ed.), *Hansisches und hansestädtisches Recht*, Trier 2008, 91–112 — written vs oral law in medieval Reval (German).
5. B. Kannowski, "Bürgerrecht," Hansisches Lexikon PDF, Uni Hamburg — Burspraken duties: Schoß, Wacht, Harnisch (German).
6. Same as [4] — everyday legal practice beyond codex verbatim use.
7. Universität Passau Stadtrecht excerpt, Art. 240 *borgnerscap*, https://www.jura.uni-passau.de/muessig/lehre-lehrmaterialien/wintersemester-20052006/quellenuebung-im-deutschen-recht/4-stadtrechte — citizenship from age 12 (German).
8. [`estonian-and-german-populations.md`](../people/estonian-and-german-populations.md) — who lacks burgher standing (project dossier).
9. NA-Verlag / Götzmann ed., Bardewik Codex preview, Art. 179 — no foreign campaign; defend city (German).
10. Korlén, *Norddeutsche Stadtrechte II*, Lund 1951 — earliest MLG Lübeck law with Reval variants (German).
11. T. Kala, "Old Documents – New Meanings," *EAA* 2022, https://doi.org/10.12697/aa.2022.2-3.04 — daughter-town selective use of Lübeck paragraphs (English).
12. Hamburg Universität, Lübeck Stadtrecht excerpt, Arts. 31, 90, 91, https://www.spaetmittelalter.uni-hamburg.de/spaetmittelalter/luebeck/stadtrecht.html — MLG text (German).
13. D. Nicolle, *Forces of the Hanseatic League*, Osprey MAA 494, 2014 — militia kit tiers (English).
14. M. Hundt, "Bürger und Garnison," Lübeck Hefte 62 — 1188 Heerfreiheit ↔ self-defence including wall watch (German PDF).
15. Britannica, "Laws of Lübeck," https://www.britannica.com/topic/laws-of-Lubeck — common defence among daughter towns (English).
16. British History Online, London gate provisions 1282, https://www.british-history.ac.uk/no-series/memorials-london-life/pp21-22 — curfew/gate comparandum (English).
17. [`watch-duty-and-town-defence.md`](../military/watch-duty-and-town-defence.md) — operational watch routine (project dossier).
18. Same as [14] — burghers not impressed for external war; mercenaries instead (German).
19. [`jurisdictions-of-reval.md`](./jurisdictions-of-reval.md) + `history/TIMELINE.md` — April–May 1343 siege frame (project).
20. Hamburg Stadtrecht, Art. 50 false witness, https://www.spaetmittelalter.uni-hamburg.de/spaetmittelalter/luebeck/stadtrecht.html — 60 schillings + bar (German).
21. [`law-courts-and-punishment.md`](./law-courts-and-punishment.md) — 1363 Schragen gap (project dossier).
22. [`guild-structure.md`](../crafts/guild-structure.md) — craft fines vs council arms law (project dossier).
23. [`town-council-and-officers.md`](../people/town-council-and-officers.md) — 1257 seal and codex (project dossier).
24. Heidelberg LRD, Bardewik systematik, https://digi.ub.uni-heidelberg.de/lrd/einfuehrung/recht.html — article-family structure (German).
25. Passau Stadtrecht excerpt, Art. 108 *schote*, https://www.jura.uni-passau.de/muessig/lehre-lehrmaterialien/wintersemester-20052006/quellenuebung-im-deutschen-recht/4-stadtrechte — levy tradition (German).
26. Heidelberg LRD [24] — neighbourhood/path security Arts. 162–172 (German).
27. [`jurisdictions-of-reval.md`](./jurisdictions-of-reval.md) — 11 May 1343 grain levy (*DD* III:1, no. 321).
28. Urban History 2024, Reval–Lübeck appeal, https://doi.org/10.1017/s0963926824000117 — mother-city court (English).
