...
### Access recheck (2026-08-16, 15:12 UTC)

A fresh unauthenticated endpoint probe again reproduced the same zero-folio access boundary. The official AIS unit page returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects; the `TLA.230.1.Aa2` catalogue and 26 anonymous gallery markers were present. The official DGS permalink returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects, ended at VAU login, and exposed protected target `tla0230_001_0000aa2_00001_x.tif`; the response body began with an HTML doctype rather than an image signature. No authenticated image, OCR, archive-supplied transcription, or folio/page identifier was available, so zero Denkelbuch folios were inspected and no original wording, dated entry, harbour rate, crane fee, or collector name was recovered [16].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Keep `harbour_landing_due: null`, `harbour_crane_fee: null`, and dossier status `partial` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [16].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [16] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login, names the protected TIFF target, and returns HTML | Authentication boundary; no image or OCR evidence [16] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [16] |

### Access recheck (2026-08-17, 00:02 UTC)

A fresh unauthenticated direct probe reproduced the same zero-folio boundary. The official AIS unit page returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects, the `TLA.230.1.Aa2` catalogue, and 26 anonymous gallery markers. The official DGS permalink returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login; the redirect chain exposed protected target `tla0230_001_0000aa2_00001_x.tif`, and the final response began with an HTML doctype rather than an image signature. No authenticated image, OCR, archive-supplied transcription, or folio/page identifier was available, so zero Denkelbuch folios were inspected and no original wording, dated entry, harbour rate, crane fee, or collector name was recovered [17].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Keep `harbour_landing_due: null`, `harbour_crane_fee: null`, and dossier status `partial` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [17].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [17] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login, names the protected TIFF target, and returns HTML | Authentication boundary; no image or OCR evidence [17] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [17] |

### Access recheck (2026-08-17, 03:02 UTC)

A fresh unauthenticated direct probe again reproduced the same zero-folio boundary. The official AIS unit page returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects and 26 anonymous gallery markers for catalogue `TLA.230.1.Aa2`. The official DGS permalink returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login; its redirect chain exposed protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, and the final body began with `<!DOCTYPE html>`. No authenticated image, OCR, archive-supplied transcription, or folio/page identifier was available, so zero Denkelbuch folios were inspected and no original wording, dated entry, harbour rate, crane fee, or collector name was recovered [18].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Keep `harbour_landing_due: null`, `harbour_crane_fee: null`, and dossier status `partial` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [18].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [18] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login, names the protected TIFF target, and returns HTML | Authentication boundary; no image or OCR evidence [18] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [18] |

### Access recheck (2026-08-17, 15:03 UTC)

A fresh unauthenticated direct `curl -L` probe again reproduced the same zero-folio boundary. The official AIS unit page returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, and 26 anonymous gallery markers for catalogue `TLA.230.1.Aa2`. The official DGS permalink returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login; the redirect chain exposed protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, and the final body began with `<!DOCTYPE html>` rather than an image signature. No authenticated image, OCR, archive-supplied transcription, or folio/page identifier was available, so zero Denkelbuch folios were inspected and no original wording, dated entry, harbour rate, crane fee, or collector name was recovered [19].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Keep `harbour_landing_due: null`, `harbour_crane_fee: null`, and dossier status `partial` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [19].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [19] |
...
### Access recheck (2026-08-18, 18:02 UTC)

Fresh direct unauthenticated requests reproduced the same zero-folio boundary. The official AIS unit page returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects, catalogue `TLA.230.1.Aa2`, and 26 anonymous `Gallery image 0`-`25` markers. The DGS permalink returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects, ending at VAU login; the redirect chain exposed protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, and the final response began with an HTML doctype rather than an image signature. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [22].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Keep `harbour_landing_due: null`, `harbour_crane_fee: null`, and dossier status `partial` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [22].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [22] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final URL is VAU login and the redirect chain names the protected TIFF target; final body is HTML | Authentication boundary; no image or OCR evidence [22] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [22] |

### Access recheck (2026-08-21, 18:02 UTC)

Separate direct `curl -L` requests against the live Rahvusarhiiv routes reproduced the same zero-folio boundary. The official AIS unit page returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects; the `TLA.230.1.Aa2` catalogue and 26 anonymous `Gallery image 0`-`25` markers were present. The DGS permalink returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login; the redirect chain exposed protected target `tla0230_001_0000aa2_00001_x.tif`, and the final body began with an HTML doctype rather than an image signature. A parallel probe of the legacy `ais.tla.ee` host failed with TLS connect error `0A000438` before any catalogue HTML was returned. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [24].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Keep `harbour_landing_due: null`, `harbour_crane_fee: null`, and dossier status `partial` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [24].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [24] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login, names the protected TIFF target, and returns HTML | Authentication boundary; no image or OCR evidence [24] |
| Legacy `ais.tla.ee` probe | TLS connect error `0A000438` before catalogue HTML | Transport failure only; not evidence about the archive unit [24] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [24] |

### Access recheck (2026-08-21, 19:33 UTC)

A fresh unauthenticated probe repeated the same boundary immediately before this update. AIS returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects and the 26 anonymous gallery markers for `TLA.230.1.Aa2`. DGS followed the protected image redirect chain and returned HTTP 200 HTML after six redirects to VAU login; the response was 44,999 bytes and began with `<!DOCTYPE html>`, not a TIFF signature. The protected target remained `tla0230_001_0000aa2_00001_x.tif`. No authenticated image, OCR, transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [25].

The result remains an `environment` access blocker, not a manuscript hit or no-hit. Preserve `status: partial`, `harbour_landing_due: null`, and `harbour_crane_fee: null` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [25].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [25] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login and names the protected TIFF target; final body is HTML | Authentication boundary; no image or OCR evidence [25] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [25] |

### Access recheck (2026-08-21, 21:03 UTC)

A separate unauthenticated probe repeated the existing zero-folio boundary. The official AIS unit page returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects, 26 anonymous gallery markers, and the `TLA.230.1.Aa2` catalogue. The DGS permalink returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login; the redirect chain exposed protected target `tla0230_001_0000aa2_00001_x.tif`, while the final body began with `<!DOCTYPE html>` rather than a TIFF signature. A separate legacy `ais.tla.ee` request failed with curl error 35 / TLS `0A000438` before catalogue HTML. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [26].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Preserve `status: partial`, `harbour_landing_due: null`, and `harbour_crane_fee: null` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [26].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [26] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login and names the protected TIFF target; final body is HTML | Authentication boundary; no image or OCR evidence [26] |
...
### Access recheck (2026-08-22, 04:33 UTC)

A fresh unauthenticated probe against the exact official endpoints reproduced the existing zero-folio boundary. AIS returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, with zero redirects, the `TLA.230.1.Aa2` catalogue, and 26 anonymous gallery markers. DGS returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login; its redirect chain exposed protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, while the final body began with `<!DOCTYPE html>` rather than a TIFF signature. An isolated request to the legacy `ais.tla.ee` host failed with curl error 35 / TLS connect error `0A000438` and produced no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [28].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Preserve `status: partial`, `harbour_landing_due: null`, and `harbour_crane_fee: null` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [28].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [28] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login and names the protected TIFF target; final body is HTML | Authentication boundary; no image or OCR evidence [28] |
| Legacy `ais.tla.ee` probe | curl error 35 / TLS connect error `0A000438` with no response body | Transport failure only; not evidence about the archive unit [28] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [28] |

### Access recheck (2026-08-22, 06:02 UTC)

A fresh direct probe against the exact official endpoints reproduced the existing zero-folio boundary. AIS returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, and the `TLA.230.1.Aa2` catalogue with 26 anonymous gallery markers; its body was HTML, not a manuscript image. DGS returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`; its body began with `<!DOCTYPE html>` and did not carry a TIFF signature. An isolated request to legacy `ais.tla.ee` failed with curl error 35 / TLS connect error `0A000438` and produced no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [29].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Preserve `status: partial`, `harbour_landing_due: null`, and `harbour_crane_fee: null` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [29].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers | Catalogue/preview metadata only; no folio text [29] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login and names the protected TIFF target; final body is HTML, not TIFF | Authentication boundary; no image or OCR evidence [29] |
| Legacy `ais.tla.ee` probe | curl error 35 / TLS connect error `0A000438` with no response body | Transport failure only; not evidence about the archive unit [29] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [29] |


### Access recheck (2026-08-22, 18:05 UTC)

A fresh independent probe against the exact official endpoints reproduced the existing zero-folio boundary. AIS returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, and the `TLA.230.1.Aa2` catalogue with 26 anonymous gallery markers; the body began with an HTML doctype and was not a manuscript image. DGS followed six redirects and returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes at the VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`; the isolated final body began with `<!DOCTYPE html>` and had no TIFF signature. An isolated request to legacy `ais.tla.ee` failed with curl error 35 / TLS connect error `0A000438` and produced no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [30].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Preserve `status: partial`, `harbour_landing_due: null`, and `harbour_crane_fee: null` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [30].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers; body is HTML | Catalogue/preview metadata only; no folio text [30] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login and names the protected TIFF target; signature is HTML, not TIFF | Authentication boundary; no image or OCR evidence [30] |
| Legacy `ais.tla.ee` probe | curl error 35 / TLS connect error `0A000438` with no response body | Transport failure only; not evidence about the archive unit [30] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [30] |

### Access recheck (2026-08-22, 20:33 UTC)

A fresh independent probe against the exact official endpoints reproduced the existing zero-folio boundary. AIS returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, and the `TLA.230.1.Aa2` catalogue with 26 anonymous gallery markers; its body began with an HTML doctype and was not a manuscript image. DGS followed six redirects and returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes at the VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`; the isolated final body began with `<!DOCTYPE html>` and had no TIFF signature. An isolated request to legacy `ais.tla.ee` failed with curl error 35 / TLS connect error `0A000438` and produced no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, original wording, dated harbour rate, crane fee, or collector name was recovered; zero Denkelbuch folios were inspected [31].

This remains an `environment` access blocker, not a manuscript hit or no-hit. Preserve `status: partial`, `harbour_landing_due: null`, and `harbour_crane_fee: null` until `R-502` enables lawful authenticated VAU/DGS access or the archive supplies a provenance-preserving scan/transcription covering the 1340-1343 folios with identifiers and original wording [31].

| Probe | Observed result | Evidence boundary |
|---|---|---|
| AIS unit page | HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects; catalogue plus 26 anonymous gallery markers; body is HTML | Catalogue/preview metadata only; no folio text [31] |
| DGS permalink | HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects; final page is VAU login and names the protected TIFF target; signature is HTML, not TIFF | Authentication boundary; no image or OCR evidence [31] |
| Legacy `ais.tla.ee` probe | curl error 35 / TLS connect error `0A000438` with no response body | Transport failure only; not evidence about the archive unit [31] |
| Authenticated folio review | No lawful authenticated session or provenance-preserving archive export available | Zero folios; no responsible harbour-term hit or no-hit [31] |
...
16. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-16 15:12 UTC): fresh unauthenticated `curl -L` requests returned AIS HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with the `TLA.230.1.Aa2` catalogue and 26 anonymous gallery markers; DGS returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, and the response body began with an HTML doctype rather than an image signature. No authenticated image, OCR, archive-supplied transcription, or folio/page identifier was available; zero folios were inspected. Official endpoints: https://ais.ra.ee/en/description-unit/view?id=124030010181&ru=5GsV5p and https://www.ra.ee/dgs/_purl.php?shc=TLA.230.1.Aa2. Clearing dependency: `R-502`.
...
21. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-18 05:32 UTC): fresh unauthenticated `curl -L` requests returned AIS HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with catalogue `TLA.230.1.Aa2` and 26 anonymous gallery markers; DGS returned HTTP 200 `text/html; charset=UTF-8` after six redirects to VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, and the final body began with `<!DOCTYPE html>` rather than an image signature. No authenticated image, OCR, archive-supplied transcription, or folio/page identifier was available; zero Denkelbuch folios were inspected. Official endpoints: https://ais.ra.ee/en/description-unit/view?id=124030010181&ru=5GsV5p and https://www.ra.ee/dgs/_purl.php?shc=TLA.230.1.Aa2. Clearing dependency: `R-502`.
22. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-18 18:02 UTC): fresh unauthenticated requests returned AIS HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with catalogue `TLA.230.1.Aa2` and 26 anonymous gallery markers; DGS returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, and the final body began with an HTML doctype rather than an image signature. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, or original wording was available; zero Denkelbuch folios were inspected. Official endpoints: https://ais.ra.ee/en/description-unit/view?id=124030010181&ru=5GsV5p and https://www.ra.ee/dgs/_purl.php?shc=TLA.230.1.Aa2. Clearing dependency: `R-502`.
23. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-19 01:03 UTC): fresh unauthenticated requests returned AIS HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with catalogue `TLA.230.1.Aa2` and 26 anonymous gallery markers; DGS returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, and the final body began with an HTML doctype rather than an image signature. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, or original wording was available; zero Denkelbuch folios were inspected. Official endpoints: https://ais.ra.ee/en/description-unit/view?id=124030010181&ru=5GsV5p and https://www.ra.ee/dgs/_purl.php?shc=TLA.230.1.Aa2. Clearing dependency: `R-502`.
...
28. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-22 04:33 UTC): exact official AIS request returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with the catalogue and 26 anonymous gallery markers; exact DGS request returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login, exposing protected target `tla0230_001_0000aa2_00001_x.tif`, while the final body began with `<!DOCTYPE html>` rather than a TIFF signature. An isolated request to legacy `ais.tla.ee` failed with curl error 35 / TLS connect error `0A000438` and produced no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, or original wording was available; zero folios were inspected. Official endpoints: https://ais.ra.ee/en/description-unit/view?id=124030010181&ru=5GsV5p and https://www.ra.ee/dgs/_purl.php?shc=TLA.230.1.Aa2. Clearing dependency: `R-502`.
29. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-22 06:02 UTC): exact official AIS request returned HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with the catalogue and 26 anonymous gallery markers; exact DGS request returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes after six redirects to VAU login, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, while the final body began with `<!DOCTYPE html>` and had no TIFF signature. An isolated legacy `ais.tla.ee` request failed with curl error 35 / TLS connect error `0A000438` and produced no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, or original wording was available; zero folios were inspected. Clearing dependency: `R-502`.
30. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-22 18:05 UTC): an independent exact-endpoint probe returned AIS HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with the catalogue and 26 anonymous gallery markers; DGS followed six redirects to VAU login and returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, while the final body began with `<!DOCTYPE html>` and had no TIFF signature. An isolated legacy `ais.tla.ee` request failed with curl error 35 / TLS connect error `0A000438` and produced no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, or original wording was available; zero folios were inspected. Clearing dependency: `R-502`.
31. Rahvusarhiiv, **AIS/DGS direct access recheck**, `TLA.230.1.Aa2` (2026-08-22 20:33 UTC): an independent exact-endpoint probe returned AIS HTTP 200 `text/html; charset=UTF-8`, 95,915 bytes, zero redirects, with the catalogue and 26 anonymous gallery markers; DGS followed six redirects to VAU login and returned HTTP 200 `text/html; charset=UTF-8`, 44,999 bytes, exposing protected TIFF target `tla0230_001_0000aa2_00001_x.tif`, while the final body began with `<!DOCTYPE html>` and had no TIFF signature. An isolated legacy `ais.tla.ee` request failed with curl error 35 / TLS `0A000438` and no response body. No authenticated image, OCR, archive-supplied transcription, folio/page identifier, or original wording was available; zero folios were inspected. Clearing dependency: `R-502`.
